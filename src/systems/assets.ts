...
const rawFallbackAssetManifest: AssetManifest = {
  ...
  scenePostProfiles: {
    default: { backgroundColor: "#030712", fogColor: "#050b18", fogNear: 1450, fogFar: 4200, ambientMultiplier: 1, fillColor: "#5fc3ff", fillIntensity: 0.42, exposure: 1, bloomStrength: 0.22, bloomRadius: 0.18, bloomThreshold: 0.3, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 },
    "helion-reach": { backgroundColor: "#030712", fogColor: "#07111f", fogNear: 1550, fogFar: 4300, ambientMultiplier: 1.08, fillColor: "#5fc3ff", fillIntensity: 0.44, exposure: 1.02, bloomStrength: 0.22, bloomRadius: 0.18, bloomThreshold: 0.3, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 },
    "kuro-belt": { backgroundColor: "#050608", fogColor: "#17110b", fogNear: 1200, fogFar: 3600, ambientMultiplier: 0.92, fillColor: "#ffd166", fillIntensity: 0.32, exposure: 0.96, bloomStrength: 0.22, bloomRadius: 0.18, bloomThreshold: 0.3, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 },
    vantara: { backgroundColor: "#04080f", fogColor: "#0b1424", fogNear: 1350, fogFar: 3900, ambientMultiplier: 1, fillColor: "#8fb7ff", fillIntensity: 0.38, exposure: 1, bloomStrength: 0.22, bloomRadius: 0.18, bloomThreshold: 0.3, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 },
    "mirr-vale": { backgroundColor: "#030912", fogColor: "#061d24", fogNear: 1300, fogFar: 3850, ambientMultiplier: 1.08, fillColor: "#9bffe8", fillIntensity: 0.48, exposure: 1.04, bloomStrength: 0.34, bloomRadius: 0.24, bloomThreshold: 0.22, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.2 },
    "ashen-drift": { backgroundColor: "#070507", fogColor: "#1a0a10", fogNear: 1100, fogFar: 3400, ambientMultiplier: 0.88, fillColor: "#ff784f", fillIntensity: 0.34, exposure: 0.94, bloomStrength: 0.28, bloomRadius: 0.22, bloomThreshold: 0.24, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.2 },
    "celest-gate": { backgroundColor: "#030713", fogColor: "#101729", fogNear: 1600, fogFar: 4600, ambientMultiplier: 1.12, fillColor: "#dff8ff", fillIntensity: 0.52, exposure: 1.08, bloomStrength: 0.3, bloomRadius: 0.22, bloomThreshold: 0.24, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 },
    "ptd-home": { backgroundColor: "#02070f", fogColor: "#09122a", fogNear: 1700, fogFar: 4700, ambientMultiplier: 1.1, fillColor: "#83ecff", fillIntensity: 0.5, exposure: 1.06, bloomStrength: 0.22, bloomRadius: 0.18, bloomThreshold: 0.3, dofFocus: 0, dofAperture: 0, dofMaxBlur: 0, sharpenStrength: 0.18 }
  },
  vfxAssetProfiles: {
