...
const exactText = {
  "zh-CN": {
    ...
    "New Game": "新游戏",
    "Continue": "继续",
    "New Offline Game": "新离线游戏",
    "Continue Offline": "继续离线",
    "Online Profile": "在线档案",
    "Multiplayer": "多人",
    "No online profile active.": "当前没有在线档案。",
    "Use Login or Resume Online from the main menu to enter your online profile.": "请从主菜单使用登录或继续在线进入在线档案。",
    "pilot(s) in system": "名玩家在本星系",
    "visible pilot(s)": "名可见玩家",
    "pilot(s) docked here": "名玩家停靠在这里",
    "No online pilots in this system": "本星系没有其他在线玩家",
    "No other online pilots are docked here.": "没有其他在线玩家停靠在这里。",
    "Station Trade": "空间站交易",
    "Your offer": "你的报价",
    "Their offer": "对方报价",
    "Mission invite": "任务邀请",
  ...
  "zh-TW": {
    ...
    "New Offline Game": "新離線遊戲",
    "Continue Offline": "繼續離線",
    "Online Profile": "線上檔案",
    "Multiplayer": "多人",
    "No online profile active.": "目前沒有線上檔案。",
    "Use Login or Resume Online from the main menu to enter your online profile.": "請從主選單使用登入或繼續線上進入線上檔案。",
    "pilot(s) in system": "名玩家在本星系",
    "visible pilot(s)": "名可見玩家",
    "pilot(s) docked here": "名玩家停靠在這裡",
    "No online pilots in this system": "本星系沒有其他線上玩家",
    "No other online pilots are docked here.": "沒有其他線上玩家停靠在這裡。",
    "Station Trade": "太空站交易",
    "Your offer": "你的報價",
    "Their offer": "對方報價",
    "Mission invite": "任務邀請",
  ...
  ja: {
    ...
    "New Game": "ニューゲーム",
    "Continue": "続ける",
    "New Offline Game": "オフライン新規ゲーム",
    "Continue Offline": "オフラインで続行",
    "Online Profile": "オンラインプロフィール",
    "Multiplayer": "マルチプレイ",
    "No online profile active.": "オンラインプロフィールが有効ではありません。",
    "Use Login or Resume Online from the main menu to enter your online profile.": "メインメニューのログインまたはオンライン再開からオンラインプロフィールに入ってください。",
    "pilot(s) in system": "人がこの星系にいます",
    "visible pilot(s)": "人が視認可能",
    "pilot(s) docked here": "人がここに停泊中",
    "No online pilots in this system": "この星系に他のオンラインパイロットはいません",
    "No other online pilots are docked here.": "ここに停泊中の他のオンラインパイロットはいません。",
    "Station Trade": "ステーション取引",
    "Your offer": "自分の提示",
    "Their offer": "相手の提示",
    "Mission invite": "ミッション招待",
    "Resume Online": "オンライン再開",
    "Callsign": "コールサイン",
    "Register": "登録",
    "Login": "ログイン",
    "Disconnect": "切断",
  ...
  fr: {
    ...
    "Continue": "Continuer",
    "New Offline Game": "Nouvelle partie hors ligne",
    "Continue Offline": "Continuer hors ligne",
    "Online Profile": "Profil en ligne",
    "Multiplayer": "Multijoueur",
    "No online profile active.": "Aucun profil en ligne actif.",
    "Use Login or Resume Online from the main menu to enter your online profile.": "Utilisez Connexion ou Reprendre en ligne depuis le menu principal pour entrer dans votre profil en ligne.",
    "pilot(s) in system": "pilote(s) dans le systeme",
    "visible pilot(s)": "pilote(s) visible(s)",
    "pilot(s) docked here": "pilote(s) amarres ici",
    "No online pilots in this system": "Aucun autre pilote en ligne dans ce systeme",
    "No other online pilots are docked here.": "Aucun autre pilote en ligne n'est amarre ici.",
    "Station Trade": "Echange en station",
    "Your offer": "Votre offre",
    "Their offer": "Leur offre",
    "Mission invite": "Invitation de mission",
    "Resume Online": "Reprendre en ligne",
    "Callsign": "Indicatif",
    "Register": "S'inscrire",
    "Login": "Connexion",
