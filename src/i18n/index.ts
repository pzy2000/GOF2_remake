...
const exactText = {
  "zh-CN": {
    ...
    "First run complete. Next: follow Glass Wake 02, Economy, or Quiet Signals.": "首次航程完成。下一步可继续 Glass Wake 02、经济调度或静默信号。",
    ...
    "Approach Helion Prime Exchange and press E when the dock prompt appears.": "接近 Helion Prime Exchange，在停靠提示出现时按 E。",
    ...
    "Complete Clean Carrier at Mirr Lattice to finish the first flight loop.": "在 Mirr Lattice 完成 Clean Carrier，结束首次飞行闭环。",
  ...
  ja: {
    ...
    "First run complete. Next: follow Glass Wake 02, Economy, or Quiet Signals.": "初回航行完了。次は Glass Wake 02、経済、または Quiet Signals へ。",
    "Collapse": "折りたたむ",
    "Expand": "展開",
    "Open Board": "ボードを開く",
    "Open Map": "マップを開く",
    ...
    "Approach Helion Prime Exchange and press E when the dock prompt appears.": "Helion Prime Exchange に接近し、ドック表示が出たら E を押す。",
    ...
    "Complete Clean Carrier at Mirr Lattice to finish the first flight loop.": "Mirr Lattice で Clean Carrier を完了し、初回ループを終える。",
  ...
  fr: {
    ...
    "First run complete. Next: follow Glass Wake 02, Economy, or Quiet Signals.": "Premier trajet termine. Ensuite: Glass Wake 02, Economie ou Quiet Signals.",
    "Collapse": "Replier",
    "Expand": "Deplier",
    ...
    "Approach Helion Prime Exchange and press E when the dock prompt appears.": "Approchez Helion Prime Exchange et appuyez sur E quand l'invite d'amarrage apparait.",
    ...
    "Complete Clean Carrier at Mirr Lattice to finish the first flight loop.": "Terminez Clean Carrier a Mirr Lattice pour conclure la premiere boucle.",
